...
namespace Presentation.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        [HttpHead]
        [HttpGet(Name ="GetAllBooksAsync")] //ben yazdım silebilirim.
        ...
        [HttpPost]
        public async Task<IActionResult> CreateOneBookAsync([FromBody] BookDtoForInsertion bookDto) //ilgili bilginin reguestin body'sinden geldiğini belli ettik.
        {
